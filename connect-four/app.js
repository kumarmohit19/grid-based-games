document.addEventListener('DOMContentLoaded',() => {
    ...
    for(var i = 0, len = squares.length; i < len; i++)
        ...
        squares[i].onclick = function(){
            ...
            if (squares[index + 7].classList.contains('taken') && !squares[index].classList.contains('taken')) {//
                ...
                //if the square below your current square is not taken , alert that you can't go here
    ...
    function checkBoard() {  
        ...
        // now check those arrays to see if they all have the same class of player-one
            ...
            // now chekc if they all have player-two class
...
//add an eventListener in each square that will trigger the checkBoard function on click
